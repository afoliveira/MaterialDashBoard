...
class GestaoPessoas extends Component {
  ...
  handleSubmit(event) {
    ...
    const { gpe_id_gpe,gpe_nom_pessoa,gpe_dat_cadastro, gpe_dat_nascimento,gpe_nom_sobre_pessoa,operacao } = this.state;
    axios.post('http://localhost:8000/api/gestao-pessoas/novo', { gpe_id_gpe,gpe_nom_pessoa,gpe_dat_cadastro, gpe_dat_nascimento,gpe_nom_sobre_pessoa,operacao })
    .then((result) => {
  ...
  componentDidMount() { //evento on load
    debugger;
   ...
   axios.get(`http://localhost:8000/api/gestao-pessoas/limite/4`)
      .then((result) => {
        console.log(result);
          ...
          <GridItem xs={12} sm={12} md={8}>
            <Card>
              <CardHeader color="primary">
                <h4 className={classes.cardTitleWhite}>Editar perfil de Pessoa</h4>
              ...
              <CardFooter>
                <Button color="primary" onClick={this.handleSubmit}>Salvar Dados</Button>
                <Button color="info" onClick={this.Listagem}>Listar Pessoas</Button>
              </CardFooter>
            </Card>
          </GridItem>
